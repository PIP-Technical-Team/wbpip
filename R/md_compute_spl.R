...
#' @param ppp numeric: PPP values inputed by the user (set to 1 if welfare values are already in dollars)
#' @param cpi numeric: CPI values inputed by the user (set to 1 if welfare values year is the reference year)
#'
#' @return numeric
#' @keywords internal
#'
