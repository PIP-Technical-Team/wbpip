...
#'
#' @examples
#' wbpip:::md_compute_poverty_stats_old(
#'   welfare = 1:2000,
#'   weight = rep(1, 2000),
#'   povline_lcu = 10)
#'
#' @return list
#' @keywords internal
md_compute_poverty_stats_old <- function(welfare, weight, povline_lcu) {
